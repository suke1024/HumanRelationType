...
const QUESTIONS = [
  ...
  // ③ 冷淡でよそよそしい
  { id: 17, text: "相手と長い期間にわたる関わりあい（コミット）を持つことが苦手である", category: 3 },
  ...
  { id: 26, text: "初対面の人に、自分を紹介することが苦手である", category: 4 },
  ...
  { id: 30, text: "他者に対して、自分の心を開き、気持ちを伝えることが苦手である", category: 4 },
  ...
  { id: 34, text: "自分をわずらわせるのを止めて欲しいと，他者に伝えることが苦手である", category: 5 },
  ...
  { id: 39, text: "必要な場合には、断固とした態度をとることが苦手である", category: 5 },
  ...
  { id: 45, text: "他者の気持ちを傷つけることを怖れずに、自己主張することが苦手である", category: 6 },
  ...
  { id: 60, text: "他者の問題の解決に，私は責任を感じ過ぎる", category: 8 },
